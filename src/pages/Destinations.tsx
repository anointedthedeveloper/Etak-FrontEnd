...
import { ImageSlot, Badge } from '../components/ui/index'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-md mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-white text-[#172033] placeholder-[#667085] focus:outline-none focus:ring-2 focus:ring-[#08A9E0] text-sm"
            />
          </div>
        </div>
      </div>
