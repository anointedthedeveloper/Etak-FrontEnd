            ...
            <div className="flex items-center gap-3">
              {socials.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  className="hover-rotate w-9 h-9 rounded-lg bg-white/5 border border-white/10 text-blue-300 hover:bg-[#08A9E0] hover:text-white hover:border-[#08A9E0] hover:shadow-lg hover:shadow-[#08A9E0]/25 flex items-center justify-center"
                >
                  <Icon size={14} />
                </a>
              ))}
